...
writer.writerow(['owner', 'name', 'is_valid', 'language', 'n_issues', 'n_prs', 'n_stars', 'n_forks', 'n_contributors'])
...
for index, row in dataframe.iterrows():
    try:
        ...
        writer.writerow([owner, name, is_valid, first_language, num_issues, num_pull_requests, num_stars, num_forks, num_contributors])
        
    except:
        with open('ignored.txt', 'a') as ignored_file:
            ignored_file.write(owner + '/' + name + '\n')
